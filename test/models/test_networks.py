...
def test_make_mlp():
    ...
    assert type(mlp.layers[1]) is ACTIVATIONS["relu"], "Activation 0 is not correct."
    assert type(mlp.layers[3]) is ACTIVATIONS["relu"], "Activation 1 is not correct."
    assert type(mlp.layers[5]) is ACTIVATIONS["relu"], "Activation 2 is not correct."
...
def test_make_cnn():
    ...
    assert type(cnn.cnn[1]) is ACTIVATIONS["relu"], "Activation 0 is not correct."
    assert type(cnn.cnn[3]) is ACTIVATIONS["relu"], "Activation 1 is not correct."
    assert type(cnn.cnn[5]) is ACTIVATIONS["relu"], "Activation 2 is not correct."
